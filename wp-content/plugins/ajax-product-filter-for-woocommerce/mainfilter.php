...
{	
	...
	function phoe_Ajax_Product_Filter_menu() {
		...
		add_submenu_page( 'Ajax_Product_Filter', 'How to install Plugin', 'How to install Plugin', 'manage_options','Ajax_Product_Filter&tab=how_to_instal_ajx' , 'phoe_Ajax_Product_Filter' );
	} 
	...
	function phoe_Ajax_Product_Filter() {  ?>
		...
		<div id="profile-page" class="wrap">
			...
			<h2 class="nav-tab-wrapper woo-nav-tab-wrapper">
				...
				<a class="nav-tab <?php if($tab == 'how_to_instal_ajx' ){ echo esc_html( "nav-tab-active" ); } ?>" href="?page=Ajax_Product_Filter&amp;tab=how_to_instal_ajx"><?php _e('How to install plugin','Ajax_Product_Filter'); ?></a>
		...
		if($tab == 'how_to_instal_ajx' )
		{
				include_once(plugin_dir_path(__FILE__).'includes/phoen_how_to_instal_ajx_prod.php');
